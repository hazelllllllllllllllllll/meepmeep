...
import type { ScreenShareCaptureOptions, TrackPublishOptions, VideoCaptureOptions, VideoCodec, VideoEncoding } from './options';
...
export default class LocalVideoTrack extends LocalTrack<Track.Kind.Video> {
    ...
    applyScreenShareConstraints(constraints: Pick<ScreenShareCaptureOptions, 'resolution' | 'contentHint'>, videoEncoding?: VideoEncoding): Promise<void>;
