 ...
 */
type Experimental__BatchExtractorType = {
    /**
     * Determine whether this extractor should handle the given file.
     */
    match(filename: string): boolean;
     ...
     */
    extractFromFiles(filenames: string[], onMessageExtracted: (msg: ExtractedMessage) => void, ctx: ExtractorCtx): Promise<void>;
};
type ExtractorType = PerFileExtractorType | Experimental__BatchExtractorType;
 ...
 */
type ExperimentalExtractorBundler = {
    bundle(entryPoints: string[], outDir: string, linguiConfig: LinguiConfigNormalized): Promise<BundleResult>;
};
 ...
 */
type DeprecatedPseudoLocaleString = string;
/**
 ...
 */
type PseudoLocaleConfigNormalized = {
    locale: string;
    options: PseudoLocaleOptions;
};
type ModuleSourceNormalized = readonly [module: string, specifier: string];
type LinguiConfigNormalized = Omit<LinguiConfig & typeof defaultConfig, "runtimeConfigModule" | "pseudoLocale"> & {
...
export type { BundleChunk, BundleResult, CatalogConfig, CatalogFormatter, CatalogType, DeprecatedPseudoLocaleString, ExperimentalExtractorBundler, ExperimentalExtractorOptions, Experimental__BatchExtractorType, ExtractedCatalogType, ExtractedMessage, ExtractedMessageType, ExtractorCtx, ExtractorType, FallbackLocales, LinguiConfig, LinguiConfigNormalized, MessageOrigin, MessageType, OrderBy, OrderByFn, PerFileExtractorType, PseudoLocaleConfig, PseudoLocaleConfigNormalized, PseudoLocaleOptions };
