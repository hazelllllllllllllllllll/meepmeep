...
type ListboxMUSUDBaseProps<V> = ListboxBaseProps & ListboxMultipleBaseProps<V> & Omit<HeadlessSelectMultipleUncontrolledOptions<V>, 'onChange'> & Omit<HeadlessDisclosureUncontrolledOptions, 'onChange'> & {
    children?: JSX.Element;
};
export type ListboxMUSUDProps<V, T extends ValidConstructor = typeof Fragment> = HeadlessProps<T, ListboxMUSUDBaseProps<V>>;
