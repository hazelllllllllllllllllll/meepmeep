...
type ListboxMCSUDBaseProps<V> = ListboxBaseProps & ListboxMultipleBaseProps<V> & Omit<HeadlessSelectMultipleControlledOptions<V>, 'onChange'> & Omit<HeadlessDisclosureUncontrolledOptions, 'onChange'> & {
    children?: JSX.Element;
};
export type ListboxMCSUDProps<V, T extends ValidConstructor = typeof Fragment> = HeadlessProps<T, ListboxMCSUDBaseProps<V>>;
