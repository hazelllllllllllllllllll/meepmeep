...
type SelectMultipleUncontrolledBaseProps<V> = SelectBaseProps & HeadlessSelectMultipleUncontrolledOptions<V> & HeadlessSelectRootChildren<V>;
export type SelectMultipleUncontrolledProps<V, T extends ValidConstructor = 'ul'> = HeadlessPropsWithRef<T, SelectMultipleUncontrolledBaseProps<V>>;
