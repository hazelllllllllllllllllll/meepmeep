 ...
 * set.delete(2)
 */
export declare class ReactiveWeakSet<T extends object> extends WeakSet<T> {
    #private;
    constructor(values?: Iterable<T> | null);
    has(value: T): boolean;
    add(value: T): this;
...
/** @deprecated */
export declare function createSet<T>(initial?: T[]): SignalSet<T>;
/** @deprecated */
export declare function createWeakSet<T extends object>(initial?: T[]): ReactiveWeakSet<T>;
