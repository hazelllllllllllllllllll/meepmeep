...
var QRCodeSVG = (_props) => {
  ...
  return <svg width={props.width} height={props.height}><For each={rectangles()}>{(rectangle) => <rect
    width={moduleSizeWidth()}
    height={moduleSizeHeight()}
    x={rectangle.x}
    y={rectangle.y}
    style={{
      fill: rectangle.enabled ? props.foregroundColor : props.backgroundColor,
      opacity: rectangle.enabled ? props.foregroundAlpha : props.backgroundAlpha
    }}
  />}</For></svg>;
};
var QRCodeCanvas = (_props) => {
  ...
  return <canvas ref={(e) => ref = e} height={props.height} width={props.width} />;
};
