...
type SelectMultipleControlledBaseProps<V> = SelectBaseProps & HeadlessSelectMultipleControlledOptions<V> & HeadlessSelectRootChildren<V>;
export type SelectMultipleControlledProps<V, T extends ValidConstructor = 'ul'> = HeadlessPropsWithRef<T, SelectMultipleControlledBaseProps<V>>;
