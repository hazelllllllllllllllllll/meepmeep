...
type ListboxSCSUDBaseProps<V> = ListboxBaseProps & ListboxSingleBaseProps<V> & Omit<HeadlessSelectSingleControlledOptions<V>, 'onChange'> & Omit<HeadlessDisclosureUncontrolledOptions, 'onChange'> & {
    children?: JSX.Element;
};
export type ListboxSCSUDProps<V, T extends ValidConstructor = typeof Fragment> = HeadlessProps<T, ListboxSCSUDBaseProps<V>>;
