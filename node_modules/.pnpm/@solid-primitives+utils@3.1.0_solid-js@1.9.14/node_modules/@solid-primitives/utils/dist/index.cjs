...
// src/index.ts
var noop = () => void 0;
var isServer = web.isServer;
var isClient = !isServer;
var isDev = solidJs.DEV && isClient;
var isProd = !isDev;
...
var onRootCleanup = (fn) => solidJs.getOwner() ? solidJs.onCleanup(fn) : fn;
...
var createTrigger = isDev ? () => solidJs.createSignal(void 0, { equals: false, name: "trigger" }) : () => solidJs.createSignal(void 0, { equals: false });
...
exports.asAccessor = asAccessor;
exports.asArray = asArray;
exports.chain = chain;
exports.clamp = clamp;
exports.compare = compare;
exports.createCallbackStack = createCallbackStack;
...
exports.createWeakTriggerCache = createWeakTriggerCache;
...
exports.onRootCleanup = onRootCleanup;
