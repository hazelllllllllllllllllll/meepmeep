 ...
 * userPoints.set(user1, { foo: "bar" });
 */
export declare class ReactiveWeakMap<K extends object, V> extends WeakMap<K, V> {
    #private;
    constructor(entries?: Iterable<readonly [K, V]> | null);
    has(key: K): boolean;
    get(key: K): V | undefined;
...
/** @deprecated */
export declare function createMap<K, V>(initial?: [K, V][]): SignalMap<K, V>;
/** @deprecated */
export declare function createWeakMap<K extends object, V>(initial?: [K, V][]): ReactiveWeakMap<K, V>;
